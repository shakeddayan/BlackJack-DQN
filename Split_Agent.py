...
class Split_Agent: #THE SPLIT MODEL
    ...
    def get_Action (self, state, epoch = 0, start_epoch = 0, events= None, train = True): #get the decision whether to split or no.
